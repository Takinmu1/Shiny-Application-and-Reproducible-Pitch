...
This presentation will be used to promote the shiny app created to graph mtcars data.  The app will help display the relationship between miles per gallon and horsepower filtered based on the number of cylinders a car has.
